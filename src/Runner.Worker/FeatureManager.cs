...
namespace GitHub.Runner.Worker
{
    public class FeatureManager
    {
        ...
        public static bool IsStallDetectEnabled(Variables variables)
        {
            ...
            var isStallDetectPathSet = !string.IsNullOrEmpty(Environment.GetEnvironmentVariable(Constants.Hooks.StallDetectPath));
            return isStallDetectFeatureFlagSet && isStallDetectPathSet;
        }
    }
}
